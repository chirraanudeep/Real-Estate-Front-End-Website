        ...
        <div className='flexColStart hero-left'>
          ...
          <div className='flexCenter stats'>
            <div className='flexColCenter stat'>
              ...
              <span className='secondaryText align'>Premium Products</span>
            </div>
            ...
            <div className='flexColCenter stat'>
              ...
              <span className='secondaryText align'>Happy Customers</span>
            </div>
            ...
            <div className='flexColCenter stat'>
              ...
              <span className='secondaryText align'>Award Winning</span>
            </div>
          </div>
